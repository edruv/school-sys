<?php
	...
	if (isset($_POST['ediemp'])) {
		...
		(!empty($mailac)) ? (preg_match('/^([\w\.\-_]+)?\w$/',$mailac)) ? $a++ : array_push($errors,'el email "'.$mailac.'@docentes.schoolduck.com"" no es valido') : array_push($errors,'ingresa un email');
