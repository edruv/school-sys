<?php
		...
		if ($a > 6) {
			...
			if ($regsec == 2) {
				...
				try {
					...
					$stat = $conn->prepare("INSERT into seccion(namsec,materia,cupo,disp,dias,aula,hra_ini,hra_fin,f_ini,f_fin,maestro) values(:nsec,:mater,:cupo,:disp,:dias,:aula,:hini,:hfin,:fini,:ffin,:maestro)");
	...
	echo $twig->render('secc_addv2.twig',compact('title','user','profs','aued','matters','horarios','errors','messa','post'));
?>
